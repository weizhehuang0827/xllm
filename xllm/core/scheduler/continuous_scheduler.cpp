...
ContinuousScheduler::ContinuousScheduler(Engine* engine, const Options& options)
  ...
  profile_manager_options.dp_size(options.dp_size())
      ...
      .profile_h2d_time(options.profile_h2d_time())
      .profile_h2d_time_with_d2h(options.profile_h2d_time_with_d2h())
      .profile_d2h_time(options.profile_d2h_time())
      .profile_fixed_d2h_blocks(options.profile_fixed_d2h_blocks())
  ...
  instance_info_.coefficients = profile_manager_->get_coefficients();
