...
LLMMaster::LLMMaster(const Options& options)
  ...
  scheduler_options.max_tokens_per_batch(options_.max_tokens_per_batch())
      ...
      .profile_h2d_time(options_.profile_h2d_time())
      .profile_h2d_time_with_d2h(options_.profile_h2d_time_with_d2h())
      .profile_d2h_time(options_.profile_d2h_time())
      .profile_fixed_d2h_blocks(options_.profile_fixed_d2h_blocks())
