...
const OptionCategory kOtherOptions = {
    ...
    {"max_concurrent_requests",
     ...
     "enable_h2d_layerwise_copy_profile",
     "h2d_layerwise_copy_profile_enable_layer_exec_profile",
     "h2d_layerwise_copy_profile_batch_size",
     "h2d_layerwise_copy_profile_context_len",
     "h2d_layerwise_copy_profile_h2d_blocks",
     "h2d_layerwise_copy_profile_steps",
     "h2d_layerwise_copy_profile_warmup_steps",
     "enable_kv_cache_utilization_profile",
     "kv_cache_utilization_profile_log_interval",
